...
export default function HiddenModals() {
    ...
    const [projects, setProjects] = useState([
        {
            image: "https://github.com/manisha9555/Music",
            status: "View Live Demo",
            ref:"./",
            description: [
                "Prototype marine web-application to provide information about progress of services and prices.",
                "Designed with  Bootstrap, Nextjs,Typescript, and ReactJS.",
                "ba;lasdjkpasj kl;djaslkjdl kasl;d l;asd ."
            ]
        },
        {
            name: "Namstespice food delivery web app",
            image: "https://github.com/manisha9555/fooddeliverywebsite",
            
            description: [
                "Marine web-application to provide information about progress of services and prices.",
                "Designed with HTML5, CSS3, Bootstrap, javascript, and ReactJS."
            ]
        },
        {
            name: "todolist",
            ...
            description: [
                ...
                "Designed with HTML, CSS, Bootstrap,  Wordpress, and ReactJS."
            ]
        }
    ]);
